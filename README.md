...
## Functions and features of the project
...
Patient can:
- Search for medical centers where he can take PCR tests
- View list of doctors and information about them, book online consultation
- See the answers to to frequently asked questions and ask own questions
- Construct personal schedule 
